...
@Component({
  selector: 'ngn-template-nx-welcome',
  template: `
    <!--
     * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
nx g @nrwl/angular:component button --project ui</pre>
          ...
          <details>
            ...
            <pre><span># see what&apos;s been affected by changes</span>nx affected:graph

            <span># run tests for current changes</span>nx affected:test

            <span># run e2e tests for current changes</span>nx affected:e2e</pre>
          </details>
        </div>
