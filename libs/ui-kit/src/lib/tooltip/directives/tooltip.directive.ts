...
// import { outZone, Overlay } from '@ngn-template/cdk';
...
// } from '../data';
// import { tooltipInvalidPositionError } from '../interactions';
...
// @Directive()
// export abstract class TooltipBase<T extends TooltipComponentBase>
...
//     private _positionAtOrigin = false;
//     private _disabled = false;
//     private _tooltipClass!: TooltipClass;
...
//             throw tooltipInvalidPositionError(position);
//         }
...
//                     let point = undefined;
//                     if (
//                         (event as MouseEvent).x !== undefined &&
//                         (event as MouseEvent).y !== undefined
//                     ) {
...
//     exportAs: 'Tooltip',
//     host: {
//         class: '-mdc-tooltip-trigger',
//     },
//     selector: '[Tooltip]',
// })
// export class Tooltip extends TooltipBase<TooltipComponent> {
...
//         defaultOptions: TooltipDefaultOptions,
//         @Inject(DOCUMENT) _document: any
//     ) {
//         super(
//             overlay,
...
// @Directive()
// export abstract class TooltipComponentBase implements OnDestroy {
...
//         if (
//             !relatedTarget ||
//             !this._triggerElement.contains(relatedTarget as Node)
//         ) {
//             if (this.isVisible()) {
